...
class Users::RegistrationsController < Devise::RegistrationsController
  ...
  # def next_create
  #   @user = User.new(session["devise.regist_data"]["user"])
  #   @personal_righting = Personal_righting.new(personal_rightings_params)
  #   unless @personal_righting.valid?
  #     flash.now[:alert] = @personal_rightings.errors.full_messages
  #     render :new_personal_righting and return
  #   end
  #   session["devise.regist_data"] = {personal_righting: @personal_righting.attributes}
  #   @delivery_address = @user.build_personal_righting
  #   render :new_delivery_address
  # end
